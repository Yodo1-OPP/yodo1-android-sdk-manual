...
### Note: 
> Player timeout onTimeLimitNotify,not only at the time of begain game, but may also happen during the game runtime.
> 
...
> 
>  result_type:8002 ,event_action==0 continue game, event_action==1 end game; event_code:11001 for played-time notification-minors,12001 for no-play-time notification-minors,50005 Generated by the third party channel SDK.
...
- Ad callbacks are processed only for successful callbacks, and failed callbacks are processed at videoIsReady/interstitialIsReady .
